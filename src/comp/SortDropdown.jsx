...
const SortDropdown = () => {
    ...
    return (
        <div className="relative inline-block text-left w-48 asdasd">
            <button
                onClick={toggleDropdown}
                className="flex items-center justify-between w-full pl-2 pr--3 py-0 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none fdsafasddfas "
            >
                <span> {selectedOption}</span>
                <svg
                    className={`w-15 h-10 ml-2 transition-transform ${isOpen ? 'transform rotate-180' : ''} fasfasf`}
